  ...
  const handleSubmit = async (values: RecurringTransactionFormValues) => {
    ...
    try {
      ...
      if (!values.accountId) {
        toast({
          variant: "destructive",
          title: tCommon("permissionDenied"),
          description: t("toast.accountRequired"),
        });
      ...
      if (result.success) {
        ...
        toast({
          title: t("toast.errorTitle"),
          description: result.error || t("toast.addFailed"),
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      <DialogTrigger asChild>
        {children || (
          <Button>
            ...
            {selectedType === "income" ? t("addRecurringIncome") : t("addRecurringExpense")}
          </Button>
        )}
      </DialogTrigger>
